...
let s:aqua        = { "gui": "#4eb4fa", "cterm": "81" }
let s:yellow      = { "gui": "#E6DB74", "cterm": "186" }
let s:orange      = { "gui": "#fd971f", "cterm": "208" }
let s:orange_light = { "gui": "#E69F66", "cterm": "208" }
...
call s:h("Search",        { "fg": s:lightgrey,  "bg": s:aqua })
...
call s:h("Character",     { "fg": s:orange_light })
...
call s:h("SpecialComment",{ "fg": s:warmgrey })
...
" Javascript
call s:h("jsClassKeyword",      { "fg": s:pink, "format": "italic" })
...
call s:h("jsFunctionKey",       { "fg": s:pink })
...
call s:h("jsSuper",             { "fg": s:aqua, "format": "italic" })
call s:h("jsFuncArgRest",       { "fg": s:purple, "format": "italic" })                                 
call s:h("jsFuncArgs",          { "fg": s:white, "format": "italic" })
call s:h("jsStorageClass",      { "fg": s:pink, "format": "italic" })
call s:h("jsDocTags",           { "fg": s:pink,   "format": "italic" })
call s:h("jsFunction",          { "fg": s:pink,   "format": "italic" })
...
" Coq
call s:h("CoqtailChecked",       { "bg": s:lightblack3 })
call s:h("CoqtailSent",          { "bg": s:lightblack3 })

" Coq Inductive
call s:h("coqIndTerm",           { "fg": s:aqua })
call s:h("coqIndConsTerm",       { "fg": s:aqua })
...
" Coq Fixpoint
call s:h("coqFixTerm",           { "fg": s:aqua })
call s:h("coqFixContent",        { "fg": s:aqua })

call s:h("coqKwd",               { "fg": s:pink })
call s:h("coqNotationKwd",       { "fg": s:pink })
call s:h("coqNotationKwd",       { "fg": s:pink })
call s:h("coqBinder",            { "fg": s:aqua })

call s:h("coqProofDelim",        { "fg": s:pink })
call s:h("coqOblOfDelim",        { "fg": s:pink })

call s:h("coqVernacPunctuation", { "fg": s:pink })
call s:h("coqAttrPunc",          { "fg": s:pink })
call s:h("coqProofPunctuation",  { "fg": s:pink })
call s:h("coqTermPunctuation",   { "fg": s:pink })

call s:h("coqVernacCmd",         { "fg": s:pink })
call s:h("coqTactic",            { "fg": s:pink })
call s:h("coqGoal",              { "fg": s:pink })

call s:h("coqTerm",              { "fg": s:aqua })
call s:h("coqGoalTerm",          { "fg": s:aqua })
call s:h("coqThmTerm",           { "fg": s:aqua })

call s:h("coqProofBody",         { "fg": s:aqua })

call s:h("coqConstructor",       { "fg": s:aqua })


call s:h("coqEqnContent",        { "fg": s:aqua })
call s:h("coqKwdParen",          { "fg": s:aqua })
